        ...
        interaceDocArr: [ // 接口文档数据
          {
            ...
            interfaceName: '查询当前登录人的评价',
            interfaceURL: '/api/evaluate/queryMyEvaluate',
            requestWay: 'POST | JSON',
            sendData: [
              {prototype: 'content', des: '评价内容', mustHave: true, remark: '无'},
              {prototype: 'companyId', des: '公司id', mustHave: false, remark: ''},
            ...
            interfaceName: '查询当前登录人的任职',
            interfaceURL: '/api/occupationalHistory/queryMyOccup',
            requestWay: 'POST | JSON',
            sendData: [
              {prototype: 'content', des: '评价内容', mustHave: true, remark: '无'},
              {prototype: 'companyId', des: '公司id', mustHave: false, remark: ''},
            ...
            interfaceName: '查询当前登录人的信息',
            interfaceURL: '/api/user/queryMyInfo',
            requestWay: 'POST | JSON',
            sendData: [
              {prototype: 'content', des: '评价内容', mustHave: true, remark: '无'},
              {prototype: 'companyId', des: '公司id', mustHave: false, remark: ''},
